...
public class RedisConfiguration {
    ...
    @Value("${app.tempPasswordExpiration}")
...
//    public class TemporaryPasswordKeyspaceConfiguration extends KeyspaceConfiguration {
//        private static final String TEMPORARY_PASSWORD_KEYSPACE = "temporary_passwords";
//
//        @Override
//        protected Iterable<KeyspaceSettings> initialConfiguration() {
//            KeyspaceSettings keyspaceSettings = new KeyspaceSettings(TemporaryPassword.class, TEMPORARY_PASSWORD_KEYSPACE);
//            keyspaceSettings.setTimeToLive(temporaryPasswordExpiration.getSeconds());
//            return Collections.singleton(keyspaceSettings);
//        }
//    }
}
